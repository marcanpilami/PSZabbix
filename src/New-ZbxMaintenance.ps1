...
function New-ZbxMaintenance
{
    ...
    .EXAMPLE
    PS> New-ZbxMaintenance -HostId 42,43 -Name "Lakenbake"
    ...
    .EXAMPLE
    PS> New-ZbxMaintenance -HostGroupId 14 -Name "Lakenbake Group"
    ...
    $result = Invoke-ZbxZabbixApi $session "maintenance.create" $prms 
    $result
}
