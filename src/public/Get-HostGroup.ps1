function Get-HostGroup
{
    ...
    Invoke-ZabbixApi $session "hostgroup.get"  $prms | ForEach-Object {$_.groupid = [int]$_.groupid; $_.PSTypeNames.Insert(0,"ZabbixGroup"); $_}
}
