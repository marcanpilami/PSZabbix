function Remove-HostGroupMembership
{
    ...
    .EXAMPLE
    PS> Get-Host | Remove-HostGroupMembership (Get-Group group1),(Get-Group group2)
    10084
    10085
    ...
    {
        Invoke-ZabbixApi $session "host.massremove" $prms | Select-Object -ExpandProperty hostids
    }
}
