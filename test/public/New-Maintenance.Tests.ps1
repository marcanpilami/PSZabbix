BeforeAll {
    . $PSScriptRoot/../../src/private/InternalTimeHelpers.ps1
    . $PSScriptRoot/../../src/public/New-Maintenance.ps1
}


Describe "New-Maintenance" {
    BeforeAll {
    ...
    Context "Parameter scenarios" {
        ...
        It "Is called with HostGroupId parameter" {
            ...
            $result = New-Maintenance -HostGroupId 3 -Name "Patch Tuesday"
        ...
        It "Check that the Name parameter is populated" {
            ...
            { New-Maintenance -HostGroupId 3 -Name "" } | Should -Throw
        }
        ...
        It "Is called with HostId parameter" {
            ...
            $result = New-Maintenance -HostId 4 -Name "Patch Tuesday"
        ...
        It "Is called with multiple HostId parameters" {
            ...
            $result = New-Maintenance -HostId 4,5,6 -Name "Patch Tuesday"
        ...
        It "requires one or the other of the -HostId and -HostGroupId parameters" {
            ...
            { New-Maintenance  -Name "Patch Tuesday" } | Should -Throw
        ...
        It "is called with the -StartTime parameter" {
            ...
            $result = New-Maintenance -HostId 4 -Name "Patch Tuesday" -StartTime $thisTime
        ...
        It "is called with the -Duration parameter" {
            ...
            $result = New-Maintenance -HostId 4 -Name "Patch Tuesday" -StartTime $thisTime -Duration $thisDuration
