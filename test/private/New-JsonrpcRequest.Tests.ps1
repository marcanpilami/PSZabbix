...
Describe "New-JsonrpcRequest" {
    It "Assembles a fully specified jsonrpc body" {
        $resultJSON = New-JsonrpcRequest -method "maintenance.get" -params @{ "output" = "extend"; "selectGroups" = "extend"; "selectTimeperiods" = "extend" } -auth "038e1d7b1735c6a5436ee9eae095879e"
    ...
    It "Defaults the output param to 'extend' on '*.get' methods" {
        $resultJSON = New-JsonrpcRequest -method "maintenance.get" -params @{ "selectGroups" = "extend"; "selectTimeperiods" = "extend" } -auth "038e1d7b1735c6a5436ee9eae095879e"
    ...
    It "Handles auth as an optional parameter" {
        $resultJSON = New-JsonrpcRequest -method "apiinfo.version" -params @{ "selectGroups" = "extend"; "selectTimeperiods" = "extend" }
    ...
    It "Contructs the params element as an array instead of hashtable, if instructed" {
        $resultJSON = New-JsonrpcRequest -method "maintenance.delete" -params @{ "array" = @(1,2)}
